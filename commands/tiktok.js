        ...
        try {
                        ...
                        for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                            ...
                            if (isVideo) {
                                await sock.sendMessage(chatId, {
                                    video: { url: mediaUrl },
                                    mimetype: "video/mp4",
                                    caption: `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 ${settings.botName || 'Brownie-MD'}`,
                                    ...channelInfo
                                }, { quoted: message });
                            } else {
                                await sock.sendMessage(chatId, {
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 ${settings.botName || 'Brownie-MD'}\n\n📝 Title: ${title}` : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 ${settings.botName || 'Brownie-MD'}`;
